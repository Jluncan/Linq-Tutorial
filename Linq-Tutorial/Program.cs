    ...
    public class Order {
        ...
        static void JoinsUsingQuery() {
            ...
            40, 49, 95, 67, 96, 60, 82, 56, 21, 84
                ...
                var integers = (from i in ints           //this is query sytax example
                                where i > 50 && i < 75 && i % 2 == 0         //this does the same thing as below
                                orderby i descending
                                select i).Sum();
                Console.WriteLine($" Sum is {integers}");

                //    var integers = ints                      // this is method syntax
